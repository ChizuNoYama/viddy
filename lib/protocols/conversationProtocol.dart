...
class ConversationProtocol {
  ...
  Future<void> startOrContinueConversationAsync(
      {List<String>? targetParticipants = null,
      Conversation? existingConversation = null}) async {
...
//TODO: Get list of conversation Id's from the BE.
  ...
  Future<Conversation?> getConversationMessagesAsync(
    ...
    try {
      ...
      Conversation conversation =
          Conversation.fromConversationData(conversationId, messageList);
  ...
  Future<void> sendMessageAsync(String payload,
